...
const form = useRef();
  ...
  const submiteHandler = (e) => {
    ...
    if(email.match(validRegex) && mobile.length ==10 && fname){
      emailjs.sendForm('service_bbrqmzm', 'template_se7vzod', form.current,"Aer6aYRchIWNP-1N_")
      .then((result) => {
        setEmail("")
        setCourse("")
        setMobile("")
        ...
        <div className=" mt-[10%]">
          <div className="pb-6 ">
            <h1 className="text-white hsize sm:text-center md:text-[30px] font-semibold">
              Contact Us For Strategic Marketing
            </h1>
          </div>
